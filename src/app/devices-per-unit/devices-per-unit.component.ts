...
@Component({
  selector: 'app-devices-per-unit',
  templateUrl: './devices-per-unit.component.html',
  styleUrls: ['./devices-per-unit.component.scss'],
})
export class DevicesPerUnitComponent implements OnInit {
