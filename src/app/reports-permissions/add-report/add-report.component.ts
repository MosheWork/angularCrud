...
export class AddReportComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<AddReportComponent>,private http: HttpClient
  ...
  onSubmit(): void {
    if (this.newRowForm.valid) {
      this.http.post('http://localhost:7144/api/ChameleonOnlineReportsAPI', this.newRowForm.value)
        .subscribe(
